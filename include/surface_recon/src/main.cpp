...
int main(int argc, char*argv[]){
    ...
    std::cout << "This is a debug version" << endl;
...
//    std::cout << "done sleeping" << endl;
    ...
    if(args_map[string("--output")] == "."){
        ...
        //t.build_png();
        t.save_obj();
        std::string comm = "assimp export "+ output+"_textured.obj mesh.stl";
        //sudp apt install assimp-tools
        int n = comm.length();
        char command_stl[n+1];
        strcpy(command_stl, comm.c_str());
        //cout << "COMMAND :" << command_stl << endl;
        system(command_stl);
    }
    else{
        ...
        //t.build_png();
        t.save_obj();
        std::string comm = "assimp export "+ output+".obj mesh.stl";
        int n = comm.length();
        char command_stl[n+1];
        strcpy(command_stl, comm.c_str());
        //cout << "COMMAND :" << command_stl << endl;
